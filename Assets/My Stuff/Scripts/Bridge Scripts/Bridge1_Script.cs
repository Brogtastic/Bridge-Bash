...
public class Bridge1_Script : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (this.anim.GetCurrentAnimatorStateInfo(0).IsName("BridgeGone"))
        {
            if ((anim.GetCurrentAnimatorStateInfo(0).normalizedTime > .15f) && (anim.GetCurrentAnimatorStateInfo(0).normalizedTime <= 1f))
            {
                ...
                GlobalEnemyCheck.bridge1dead = true;
                shake.camShake2();
        ...
        if (GlobalEnemyCheck.isEnemyFirst == false)
        {
            invincibility = true;
        ...
        if ((invincibility == true) && (GlobalEnemyCheck.isEnemyFirst == true))
        {
